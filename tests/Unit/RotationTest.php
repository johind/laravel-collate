...
it('throws for invalid rotation degrees', function () {
    expect(fn () => makeCollate()->open('doc.pdf')->rotate(45))
        ->toThrow(InvalidArgumentException::class);
});

it('throws for negative degrees', function () {
    expect(fn () => makeCollate()->open('doc.pdf')->rotate(-90))
        ->toThrow(InvalidArgumentException::class);
});
...
it('accepts 90 degrees', function () {
